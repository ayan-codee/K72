    ...
    return (
        <>
            <div className={`amimContainer w-screen h-screen fixed top-0 left-0 flex ${nav ? 'z-50' : 'z-10'}`}> 
                <div className='stair w-1/6 h-full  bg-gray-700 pointer-events-auto'></div>
                <div className='stair w-1/6 h-full  bg-gray-700 pointer-events-auto'></div>
                <div className='stair w-1/6 h-full  bg-gray-700 pointer-events-auto'></div>
                <div className='stair w-1/6 h-full  bg-gray-700 pointer-events-auto'></div>
                <div className='stair w-1/6 h-full  bg-gray-700 pointer-events-auto'></div>
            ...
            <div ref={navbarref} className='navcontainer transition-all w-screen h-screen bg-black fixed top-0  z-5 font-[font2] '>
                ...
                <div className='fixed p-2 w-screen flex justify-between'>
                    ...
                    <div className='w-20 cursor-pointer h-[5vw]  pt-6 pr-6 flex items-center justify-center'
                        onClick={() => {
                            setNav(false)
                        }}
                    >
